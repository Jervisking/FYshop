package com.demo.fyshop.order.action;
...
import com.demo.fyshop.utils.PaymentUtil;
...
public class OrderAction extends ActionSupport implements ModelDriven<Order> {
	...
	public String saveOrder() {
		...
		Cart cart = (Cart) ServletActionContext.getRequest().getSession()
				.getAttribute("cart");
		if (cart == null) {
			this.addActionError("亲!您还没有购物,请去购物!");
			return "msg";
		}
		// 设置订单的总金额:订单的总金额应该是购物车中总金额:
		order.setTotal(cart.getTotal());
		// 设置订单的状态
		order.setState(1); // 1:未付款 2:已经付款,但是没有发货 3:已经发货,但是确定发货 4:交易完成
		// 设置订单时间
		...
		if (existUser == null) {
			this.addActionError("亲!您还没有登录,请去登录!");
			return "login";
		}
	...
	public String payOrder() throws IOException {
		...
		String p3_Amt = "0.022"; // 付款金额:
		String p4_Cur = "CNY"; // 交易币种:
		String p5_Pid = ""; // 商品名称:
		String p6_Pcat = ""; // 商品种类:
		String p7_Pdesc = ""; // 商品描述:
		String p8_Url = "http://localhost:8080/FYshop/order_callBack"; // 商户接收支付成功数据的地址:
		String p9_SAF = ""; // 送货地址:
		String pa_MP = ""; // 商户扩展信息:
