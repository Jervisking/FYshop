...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/product/list.jsp"
		method="post">
			...
			<TBODY>
							...
							<s:iterator var="p" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/adminProduct_edit?pid=<s:property value="#p.pid"/>">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/adminProduct_delete?pid=<s:property value="#p.pid"/>">
											<img
				...
				<tr align="center">
					<td colspan="7">第<s:property value="pageBean.page" />/<s:property
							...
							<a
								href="${ pageContext.request.contextPath }/adminProduct_findAll?page=1">首页</a>|
								<a
								href="${ pageContext.request.contextPath }/adminProduct_findAll?page=<s:property value="pageBean.page-1"/>">上一页</a>|
							</s:if> <s:if test="pageBean.page != pageBean.totalPage">
							<a
								href="${ pageContext.request.contextPath }/adminProduct_findAll?page=<s:property value="pageBean.page+1"/>">下一页</a>|
								<a
								href="${ pageContext.request.contextPath }/adminProduct_findAll?page=<s:property value="pageBean.totalPage"/>">尾页</a>|
							</s:if>
					</td>
				</tr>
			</TBODY>
