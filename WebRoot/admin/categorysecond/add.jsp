...
<body>
	<form id="categorySecondAction_save" name="Form1"
		action="${pageContext.request.contextPath}/adminCategorySecond_save"
		method="post">
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="csname" value="" id="categorySecondAction_save_name"
					class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					所属的一级分类：</td>
			...
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					...
					<button type="submit" id="categorySecondAction_save_submit"
