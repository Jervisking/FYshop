...
<script>
	...
	function checkUsername() {
		...
		// 3.打开连接
		xhr.open("GET",
				"${pageContext.request.contextPath}/user_findByName?time="
	...
	function changeImg() {
		...
		checkImg.src = "${pageContext.request.contextPath }/checkImg?"
				+ new Date().getTime();
	}
</script>
					...
					<form id="registerForm"
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											maxlength="4" autocomplete="off"><img id="checkImg"
												...
												onclick="changeImg()" title="点击更换验证码"></span> <span><s:actionerror /></span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
						...
						<div class="login">
							...
							<dl>
								...
								<dd>
									立即登录即可体验在线购物！ <a
										href="${pageContext.request.contextPath }/user_loginPage">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
